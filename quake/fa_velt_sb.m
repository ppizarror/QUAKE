function ft = fa_velt_sb(rho, Vs, D, H)
% FT_VELT_SB: Calcula factor de amplificacion caso viscoelastico entre la
% superficie (s) y el basamento rocoso (b). H_S,RB = 2/(M+N).
%
% Parametros:
